...
int main(int argc, char*argv[])
{
 ...
 int x_len = 10; // length of the inputs
 double x1[xlen] = { 3.0, 1.0, 4.0, 2.0, 2.0, 5.0, 1.0, 3.0, 6.0, 1.0};
 double x2[xlen] = { 1.0, 4.0, 2.0, 2.0, 5.0, 1.0, 3.0, 6.0, 1.0, 8.0};

 int bias = 1; // bias = 1 or 0
 int p = 3; // lag length
 int rows = x_len - p - 1; // rows of the lag matrix
 int cols = p*2 + bias;
